About osfclient-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/osfclient-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3164&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/osfclient-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `osfclient` can be installed with `conda`:
...
```
mamba install osfclient
```

It is possible to list all of the versions of `osfclient` available on your platform with `conda`:
...
```
mamba search osfclient --channel conda-forge
```
...
mamba repoquery search osfclient --channel conda-forge

# List packages depending on `osfclient`:
mamba repoquery whoneeds osfclient --channel conda-forge

# List dependencies of `osfclient`:
mamba repoquery depends osfclient --channel conda-forge
```
